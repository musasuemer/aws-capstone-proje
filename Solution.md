...
cd /home/ubuntu/
TOKEN=$(aws --region=us-east-1 ssm get-parameter --name /oktay/capstone/token --with-decryption --query 'Parameter.Value' --output text)
git clone https://$TOKEN@github.com/okti3535/awscapstoneprojectde07tr.git
cd /home/ubuntu/awscapstoneprojectde07tr
apt install python3-pip -y
apt-get install python3.10-dev default-libmysqlclient-dev -y
pip3 install -r requirements.txt
cd /home/ubuntu/awscapstoneprojectde07tr/src
