...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/musasumer/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/musasumer/capstone", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c36eqg6k85f8.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-musa-blog' # please enter your s3 bucket name
